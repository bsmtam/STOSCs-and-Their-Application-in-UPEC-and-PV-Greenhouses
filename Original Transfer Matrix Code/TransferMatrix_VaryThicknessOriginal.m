...
%
lambda=350:5:900; % Wavelengths over which field patterns are calculated
...
layers = { 'glass' 'ITO' 'CuSCN' 'Y6' 'BCP' 'Al'}; % Names of layers of materials starting from side light is incident from
thicknesses = [0 110 60 108 10 200];  % thickness of each corresponding layer in nm (thickness of the first layer, and layer which thickness is varied is irrelivant)
...
VaryThickness = 0:5:100; % thickness values for layer that will be varied in thickness in nm
