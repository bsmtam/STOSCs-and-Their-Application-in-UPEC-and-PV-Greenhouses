...
%
lambda=300:5:900; % Wavelengths over which field patterns are calculated
...
layers = { 'glass' 'ITO' 'MoO3' 'P3HTPCBM' 'TiO2' 'ITO'}; % Names of layers of materials starting from side light is incident from
thicknesses = [1000 70 30 50 30 70 ];  % thickness of each corresponding layer in nm (thickness of the first layer is irrelivant)
